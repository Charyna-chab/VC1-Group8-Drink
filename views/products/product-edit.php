...
<div class="card shadow mb-4 ml-3 mr-3" style="width: 50%; border-radius: 0.75rem;">
    <div class="card-body">
        <div class="container">
            ...
            <form action="/admin/products/update/<?= $product['product_id'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <a href="/admin/products" class="btn btn-secondary mt-3 rounded-pill px-4 ms-2">Cancel</a>
            </form>
        </div>
    </div>
</div>