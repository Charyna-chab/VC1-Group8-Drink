        ...
        <div class="col-md-6">
            <form action="/admin/products/store" method="POST" enctype="multipart/form-data" class="border border-2 rounded-4 p-4 shadow-sm bg-light">
                ...
                <div class="mb-3">
                    ...
                    <select id="category" name="category" class="form-control rounded-pill">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success w-100 rounded-pill" data-bs-toggle="modal" data-bs-target="#successModal">Submit</button>
                </div>
            </form>
        </div>
    </div>
