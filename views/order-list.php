...
<section class="content">
    <div class="order-list-container">
        ...
        <div class="order-list-filters">
            <form action="/admin/order-list" method="GET" class="filter-form">
                ...
                <a href="/admin/order-list" class="btn-reset">Reset</a>
            </form>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (isset($products[$order['product_id']])) {
                                        echo $products[$order['product_id']]['product_name'];
                                    } else {
                                        echo 'Product #' . $order['product_id'];
                                    }
                                    ?>
                                </td>
                                <td><?= $order['drink_size']; ?></td>
